...
const CATEGORY_COLORS: Record<string, string> = {
  ALLOWANCE: 'bg-sky-100 text-sky-700 dark:bg-sky-500/15',
  SAVINGS:   'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15',
  PLANNING:  'bg-violet-100 text-violet-700 dark:bg-violet-500/15',
  CREDIT:    'bg-rose-100 text-rose-700 dark:bg-rose-500/15',
  BUDGETING: 'bg-amber-100 text-amber-700 dark:bg-amber-500/15',
  DEBT:      'bg-orange-100 text-orange-700 dark:bg-orange-500/15',
};
