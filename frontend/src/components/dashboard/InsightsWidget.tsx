...
const toneConfig: Record<InsightTone, { icon: typeof Sparkles; fg: string; bg: string }> = {
  positive: { icon: TrendingDown, fg: 'text-emerald-600', bg: 'bg-emerald-100 dark:bg-emerald-500/25 dark:text-emerald-300' },
  warning: { icon: AlertTriangle, fg: 'text-nu-gold-700', bg: 'bg-nu-gold-100 dark:bg-nu-gold-500/25 dark:text-nu-gold-300' },
  info: { icon: TrendingUp, fg: 'text-nu-blue-700', bg: 'bg-nu-blue-100 dark:bg-nu-blue-500/25 dark:text-nu-blue-300' },
  celebrate: { icon: PartyPopper, fg: 'text-pink-600', bg: 'bg-pink-100 dark:bg-pink-500/25 dark:text-pink-300' },
};
